...
**If you are using it on an Apple platform, please refer　to [kbsky-spm](https://github.com/uakihir0/kbsky-spm) or [kbsky-cocoapods](https://github.com/uakihir0/kbsky-cocoapods).**
**Also, for usage in JavaScript, please refer to [kmsskey.js](https://github.com/uakihir0/kbsky.js).**
